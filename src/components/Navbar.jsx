...
import { usePathname } from 'next/navigation'; // To track which page is active
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-1 text-[15px] font-semibold transition-colors cursor-pointer ${
                    isActive ? "text-pink-500" : "text-gray-900 hover:text-pink-500"
                  }`}
                >
                  {link.name}
          ...
          {navLinks.map((link) => (
            <Link
              ...
              className={`text-lg font-semibold transition-colors ${
                pathname === link.href ? "text-pink-500" : "text-gray-900 hover:text-pink-500"
              }`}
            >
              {link.name}
            </Link>
